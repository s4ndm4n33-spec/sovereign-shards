...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background shard-grid flex flex-col">
      {/* Ambient glow */}
      <div className="absolute top-0 right-1/3 w-80 h-80 bg-shard-violet/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <main className="flex-1 flex items-center justify-center px-4 relative z-10">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-shard-white mb-2">Authenticate</h1>
            <p className="text-sm text-shard-gray font-mono">Enter credentials to access operator comms</p>
          </div>
          <SignIn />
          <TestUserLoginSection />
          <div className="text-center mt-6">
            <span className="text-sm text-shard-gray">No account? </span>
            <button
